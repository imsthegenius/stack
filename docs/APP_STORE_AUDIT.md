...
- **Status:** ☐ Not fixed (requires manual capture or automation)
...
**Code-level fixes (can be done now):** B1, B3, B4, B5, B6, B7, B8, B9, B10, H5, H8, M7, M8
**Requires hosting:** B2, H1
**Requires App Store Connect:** H2, H3, H4, H6, H7, M1, M2, B11
**Requires RevenueCat dashboard:** H5
